...
/* Placeholder ricerca: colore più leggibile */
...
/* Griglia flessibile: card con larghezza naturale, proporzioni preservate */
.evidenza-grid {
    display: flex;
    flex-wrap: wrap;
...
@media (max-width: 768px) {
    ...
    /* Nasconde la scrollbar mantenendo lo scroll */
