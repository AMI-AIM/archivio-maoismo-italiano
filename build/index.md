  ...
  <div class="evidenza-grid">
    ...
    <div class="evidenza-card">
        <a href="documenti/AMI-0049/" class="evidenza-link" title="Sulla contraddizione">
            <div class="evidenza-thumbnail">
              <img data-src="https://archive.org/services/img/sulla-contraddizione" alt="Sulla contraddizione" class="lazy-img evidenza-thumbnail-img">
            </div>
    ...
    <div class="evidenza-card">
        <a href="documenti/AMI-0045/" class="evidenza-link" title="Sulla pratica">
            <div class="evidenza-thumbnail">
              <img data-src="https://archive.org/services/img/sulla-pratica" alt="Sulla pratica" class="lazy-img evidenza-thumbnail-img">
            </div>
    ...
    <div class="evidenza-card">
        <a href="documenti/AMI-0043/" class="evidenza-link" title="Sulla Nuova Democrazia">
            <div class="evidenza-thumbnail">
              <img data-src="https://archive.org/services/img/sulla-nuova-democrazia" alt="Sulla Nuova Democrazia" class="lazy-img evidenza-thumbnail-img">
            </div>
    ...
    <div class="evidenza-card">
        <a href="documenti/AMI-0013/" class="evidenza-link" title="Dichiarazione di Principio - Statuto">
            <div class="evidenza-thumbnail">
              <img data-src="https://archive.org/services/img/statuto-pcdiml" alt="Dichiarazione di Principio - Statuto" class="lazy-img evidenza-thumbnail-img">
            </div>
    ...
    <div class="evidenza-card">
        <a href="documenti/AMI-0035/" class="evidenza-link" title="Viva il popolo cinese">
            <div class="evidenza-thumbnail">
              <img data-src="https://archive.org/services/img/viva-il-popolo-cinese" alt="Viva il popolo cinese" class="lazy-img evidenza-thumbnail-img">
            </div>
...
.evidenza-card:hover .evidenza-thumbnail-img {
  transform: scale(1.04);
}

/* Griglia desktop: larghezza fissa per card uniformi (sotto i 769px
   subentra la vista a scroll orizzontale definita in extra.css, dove
   la larghezza della card segue invece quella reale della copertina) */
